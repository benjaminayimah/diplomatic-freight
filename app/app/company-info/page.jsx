          ...
          >
            ...
            <div className="flex justify-end gap-2">
              <button
                ...
                className="myHover-translate text-[0.88rem] font-medium px-4 py-2 rounded-3xl bg-gray-100 border border-gray-200 transition duration-300 hover:bg-gray-200"
              >
                Cancel
              </button>
              <SubmitButton
