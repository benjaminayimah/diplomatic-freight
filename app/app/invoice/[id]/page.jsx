...
export default function InvoicePage() {
  ...
  if (loading) return <div className="app-body-wrapper">Loading...</div>;
    ...
    <ProtectedRoute>
      <section className='app-body-wrapper'>
        <div className="mb-5">
          <div className='flex flex-col md:flex-row md:justify-between md:items-center gap-5'>
            <div className='flex items-center gap-3'>
              ...
              <div>
                ...
                <div className="text-sm text-gray-500 flex gap-2 items-center">
                  ...
                  <div className='flex gap-1'>
                    <span className='font-bold'>By:</span><span>{invoice?.createdBy}</span>
                  </div>
                </div>
            ...
            <div className='flex gap-2'>
              <Link href={`/app/create-invoice?mode=edit&id=${invoice?.id}`} className='border border-gray-200 text-black myHover-translate h-10 px-4 py-2 flex items-center justify-center font-semibold text-[0.88rem] rounded-4xl min-w-[86px]'>
                Edit invoice
              </Link>
              <SubmitButton onClick={() => handlePrint()} className={'bg-gray-200 text-black'}>
                Print / Download
              </SubmitButton>
            </div>
          </div>          
        ...
        <div className="body-content relative">
          <div className='p-4 bg-gray-50 rounded-xl border border-gray-100 mb-40 flex justify-center'>
            <div className='shadow-sm rounded-xl overflow-hidden max-w-[900px] w-full'>

              <article ref={printRef} className='bg-white'>
                <main className="p-6 sm:p-10 min-h-280">
                  {/* <!-- Invoice Header --> */}
                  <div className="flex flex-wrap justify-between gap-6 pb-5">
                    <div className="flex flex-col">
                      <p className=" text-black text-4xl font-black leading-tight tracking-[-0.033em]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="201.175" height="45" viewBox="0 0 201.175 45">
                    ...
                    <div>
                      <div className='text-4xl text-[#0077FF]'>INVOICE</div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="p-4 bg-gray-50 border border-gray-100  rounded-lg flex justify-between items-center">
                  ...
                  <div>
                    <div className="overflow-x-auto">
                      <table className="w-full text-left text-sm">
                        <thead className="bg-gray-50 border border-gray-100 text-black uppercase tracking-wider">
                          <tr>
                            ...
                            <th className="px-4 py-2 font-bold text-right">Extra Charges</th>
                          ...
                          {Array.isArray(invoice?.items) && invoice.items.length > 0 ? (
                            invoice.items.map((item, i) => (
                              <tr key={i} className="border-b border-gray-200">
                                ...
                                <td className="p-4 text-right">{Number(item?.rate || 0).toLocaleString("en-US", { style: "currency", currency: "USD" })}</td>
                                <td className="p-4 text-right">{Number(item?.extra_charges || 0).toLocaleString("en-US",{ style: "currency", currency: "USD"})}</td>
                  ...
                  <div className="flex justify-end mt-8">
                    <div className="w-full max-w-sm space-y-4  text-neutral-800">
                  ...
                  {/* <!-- Payment Information --> */}
                  <div className="mt-12 pt-8 border-t border-gray-200 grid grid-cols-1 gap-8">
                    <div>
                      <h3 className="font-bold text-black mb-2">Payment Account(s)</h3>
                      <div className='grid grid-cols-2'>
                        {
                          banks?.map((bank) => (
                          <li key={bank.id} className=" text-gray-600 text-sm space-y-1 list-decimal mb-2">
                    ...
                    <div>
                      ...
                      <p className=" text-black text-sm">Payment due within 30 days of invoice date (Net 30).</p>
                    </div>
                  </div>
                </main>
                {/* <!-- Footer --> */}
                <footer className="grid grid-cols-1 text-center p-6 sm:p-10 mt-auto border-t border-gray-200 text-gray-500 text-xs">
                  ...
                  <div className="flex gap-2 items-center mt-6 mb-6 flex-col">
                      <QRCodeCanvas
                        value={data?.qrData}
                        size={100}
                      />
