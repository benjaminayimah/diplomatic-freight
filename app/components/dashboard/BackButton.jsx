...
function BackButton() {
  ...
  return (
    <button onClick={ goBack } type='button' className='bg-gray-50 h-10 w-10 grid place-items-center rounded-3xl mb-3 border border-gray-200 hover:bg-gray-100 transition-all duration-300'>
