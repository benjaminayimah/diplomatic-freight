      ...
      <div className="bank-col flex-1">
        <div className="px-6 py-2 border bg-white border-gray-200 rounded-2xl">
          ...
          <div className="flex flex-col md:flex-row gap-2 items-start md:justify-between py-4 border-b border-gray-100">
            ...
            <div className="text-gray-600 md:text-right">{data?.bank_name}</div>
          </div>
          <div className="flex flex-col md:flex-row gap-2 items-start md:justify-between py-4 border-b border-gray-100">
            <span className="font-semibold">Bank branch</span>
            <div className="text-gray-600 md:text-right">{data?.bank_branch}</div>
          </div>
          <div className="flex flex-col md:flex-row gap-2 items-start md:justify-between py-4 border-b border-gray-100">
            <span className="font-semibold">Account name</span>
            <div className="text-gray-600 md:text-right">{data?.account_name}</div>
          </div>
          <div className="flex flex-col md:flex-row gap-2 items-start md:justify-between py-4 border-b border-gray-100">
            <span className="font-semibold">Account number</span>
            <div className="text-gray-600 md:text-right">{data?.account_number}</div>
          </div>
          <div className="flex flex-col md:flex-row gap-2 items-start md:justify-between py-4 border-b border-gray-100">
            <span className="font-semibold">SWIFT code</span>
            <div className="text-gray-600 md:text-right">{data?.swift_code}</div>
          </div>
