...
export default function RichTextEditor({
  ...
  return (
    <div className="flex flex-col gap-1 w-full">
      ...
      <div id={id} aria-label="special note" className="border border-gray-300 rounded-xl transition duration-300 overflow-hidden hover:border-gray-600 focus-within:ring-1 focus-within:ring-blue-500 focus-within:border-blue-500!">
        {/* Toolbar */}
