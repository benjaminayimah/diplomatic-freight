...
function FAQs() {
  ...
  const faqs = [
    ...
    {id: 2, title: 'How do I get a quote for a private charter flight?', body: 'Request a quote directly on our website by selecting “Get a Quote” or “Book a Private Charter.” Share your travel details and our charter team will follow up with a personalized, no-obligation quote within hours.'},
    ...
    {id: 4, title: 'What kind of aircraft are available for charter?', body: 'Our network includes a wide selection of aircraft — from light jets for short trips to large-cabin, long-range jets for international travel. We match you with the ideal aircraft based on your capacity, range, and comfort needs.'},
    {id: 5, title: 'How do you ensure the safety and security of my cargo and charter flights?', body: 'Safety is our top priority. We use secure handling protocols and advanced tracking for all freight. For charter flights, we work exclusively with operators who meet strict aviation standards. Every aircraft is maintained to the highest level and crewed by certified, highly experienced pilots.'},
  ]
